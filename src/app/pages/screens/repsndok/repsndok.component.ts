...
@Component({
  selector: 'app-repsndok',
  imports: [CommonModule, DecimalPipe, DatePipe, FormsModule, LegacyToolbarComponent, LegacyStatusBarComponent],
  templateUrl: './repsndok.component.html',
  styleUrl: './repsndok.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RepsndokComponent {
  private http = inject(HttpClient);
  readonly p = inject(PermissionService).forScreen('REPSNDOK');
